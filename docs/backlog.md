...
| P2 | Roster growth (post-67) | 67 birds after batch 7 (2026-07-13, Jared: "keep adding more birds"). Thinnest pools after the #38 tag pass: mojave-desert (7) and appalachians (9). **Batch 8 researched and ready to build: 7 candidates with commercially-safe audio verified — see docs/roster-batch8-candidates.md** (6 Appalachian incl. a PD USFWS Tufted Titmouse + Rock Wren for the Mojave; the rest of the Mojave wishlist has zero free audio, checked 2026-07-30) |
