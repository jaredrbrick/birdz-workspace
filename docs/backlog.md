...
| P2 | Photo reveal on correct guess | Jared's idea 2026-07-11: show a real photo when a bird is IDed correctly. **Confirmed viable — all 60 birds have 8–10 commercially-safe photos on Wikimedia Commons** (CC0/PD/CC-BY/CC-BY-SA, AdSense-safe). Mirrors the audio pipeline: curate 1 photo/bird (needs a per-bird check — auto-picking grabs wrong species/quality), resize ~800px, host S3 photos/ prefix + attribution.json, reveal on identify-success screen with credit. Awaiting Jared's go-ahead |
