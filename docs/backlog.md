...
|----------|------|----------------|
| P1 | Bird roster batches 4+ | 42 birds now; target ~60. Remaining thin spots: Appalachians (3), boreal forest, Chihuahuan desert |
...
| P2 | 9 birds still silent | cactus_wren, gambels_quail, brown_pelican, varied_thrush, roseate_spoonbill, american_oystercatcher, sage_thrasher, greater_sage_grouse, burrowing_owl — zero commercially-safe recordings anywhere today; recheck occasionally. mountain_bluebird audio is low quality — upgrade when possible |
